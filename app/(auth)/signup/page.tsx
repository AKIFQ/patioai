...
export default async function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      {/* Mobile layout - Compact and focused */}
      <div className="lg:hidden">
        <div className="min-h-screen flex flex-col justify-center px-4 py-8">
          {/* Compact header */}
          <div className="text-center mb-8">
            <div className="w-48 h-12 mx-auto mb-4 relative">
              <img 
            ...
            <p className="text-sm text-muted-foreground/80">Join PatioAI and start collaborating</p>
          </div>
          ...
          {/* Compact features - Below form */}
          <div className="mt-8 space-y-3 max-w-sm mx-auto">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-blue-50/40 to-transparent dark:from-blue-950/15 border border-blue-200/20 dark:border-blue-800/20">
              ...
              <div>
                <h3 className="font-medium text-xs">Create AI rooms</h3>
                <p className="text-muted-foreground/80 text-xs">Collaborate with your team</p>
              </div>
            </div>
            
            <div className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-emerald-50/40 to-transparent dark:from-emerald-950/15 border border-emerald-200/20 dark:border-emerald-800/20">
              ...
              <div>
                <h3 className="font-medium text-xs">Share instantly</h3>
                <p className="text-muted-foreground/80 text-xs">Invite anyone with links</p>
              </div>
            </div>
            
            <div className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-purple-50/40 to-transparent dark:from-purple-950/15 border border-purple-200/20 dark:border-purple-800/20">
              ...
              <div>
                <h3 className="font-medium text-xs">Real-time AI</h3>
                <p className="text-muted-foreground/80 text-xs">Get insights together</p>
              </div>
            </div>
          </div>
        </div>
