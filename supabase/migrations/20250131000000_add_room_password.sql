...
-- Create index on password for efficient lookups
CREATE INDEX IF NOT EXISTS "rooms_password_idx" ON "public"."rooms" ("password");

-- Update the join_room_safely function to check password if one is set
