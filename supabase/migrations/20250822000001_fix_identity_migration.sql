-- Fix the identity migration function
...
BEGIN
  ...
  ELSIF migration_needed THEN
    ...
    WHERE id = anonymous_participant.id;
    ...
    WHERE room_id = p_room_id 
      AND sender_name = anonymous_participant.display_name
      AND created_at >= anonymous_participant.joined_at;  -- Only messages after they joined
